...
function Open_Queries() {
  return (
    ...
    <div className='Open_Queries_Main'>
          ...
          <div className='Open_Queries_LHS_Top_Left_Icons'>
            ...
            <div className='Open_Queries_Comments_Views'>
               ...
               <div className='Open_Queries_Comments'>
                 ...
                 <div className='Open_Queries_Comment_Img'>
                   <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                 ...
                 <div className='Open_Queries_Comments_Number'>
                       7
                 </div>
               ...
               <div className='Open_Queries_Views'>
                  
                   <div className='Open_Queries_View_Img'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                   ...
                   <div className='Open_Queries_Views_Number'>
                      258
                   </div>
        ...
        <div className='Open_Queires_LHS_Top_right'>
           ...
           <div className='Open_Queries_Main_Comments'>
               <div className='Open_Queries_Comment_Big_box'>
                <input className='Open_Queries_Comment_here' placeholder='Add a Comment'></input>

                <div>
                   <button className='Open_Queries_Comment_Post_button'>Post</button>
                </div>
                ...
                <div className='Open_Queries_Actual_Sub_Comments'>
                    <div className='Open_queries_Sub_Comments_Profile'>
                        ...
                        <div className='Open_Queries_Comments_Content'>
                            ...
                            <div className='Open_Queries_Cant_Think_Of_Any_Name'>I love this design you have made.</div>
                        </div>
                    </div>
                </div>
